        ...
        {currentUser ? (
          <React.Fragment>
            <button 
              ...
              onClick={() => setCurrentView(getRoleView(currentUser.role))}
      ...
      <section className="landing-hero-card">
        ...
        <div className="hero-content-col">
          ...
          <div className="hero-action-btns">
            ...
            <button className="btn-hero-white" onClick={() => setCurrentView('explore')}>
...
function ExploreView({ setCurrentView, setSelectedBatchId }) {
    ...
    <main className="landing-main-wrapper" style={{ padding: '40px 20px 80px', maxWidth: '1200px', margin: '0 auto' }}>
      <section style={{
        ...
        <div style={{ display: 'flex', gap: '12px', marginTop: '24px', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => setCurrentView('login')} className="btn-white" style={{ padding: '12px 24px', fontSize: '0.95rem', fontWeight: 700 }}>
      ...
      <div style={{
        ...
        <div style={{ background: 'rgba(255, 255, 255, 0.8)', border: '1px solid rgba(245, 184, 20, 0.4)', borderRadius: '20px', padding: '24px', position: 'relative' }}>
        ...
        <div style={{ background: 'rgba(255, 255, 255, 0.8)', border: '1px solid rgba(34, 197, 94, 0.4)', borderRadius: '20px', padding: '24px', position: 'relative' }}>
        ...
        <div style={{ background: 'rgba(255, 255, 255, 0.8)', border: '1px solid rgba(59, 130, 246, 0.4)', borderRadius: '20px', padding: '24px', position: 'relative' }}>
        ...
        <div style={{ background: 'rgba(255, 255, 255, 0.8)', border: '1px solid rgba(168, 85, 247, 0.4)', borderRadius: '20px', padding: '24px', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '28px', marginBottom: '60px' }}>
        <article style={{ background: 'rgba(255, 255, 255, 0.9)', borderRadius: '24px', padding: '32px', border: '1.5px solid rgba(245, 184, 20, 0.5)', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            <span style={{ fontSize: '2rem' }}>🐝</span>
            <div>
              <span style={{ fontSize: '0.75rem', fontWeight: 900, textTransform: 'uppercase', color: '#854d0e', letterSpacing: '0.05em' }}>Role Dashboard 1</span>
              <h3 style={{ fontSize: '1.4rem', fontWeight: 900, color: '#0f172a', margin: 0 }}>Beekeeper Harvest & IoT Telemetry Portal</h3>
            </div>
          </div>
          ...
          <div style={{ background: '#fefce8', border: '1px solid #fde047', borderRadius: '14px', padding: '16px 20px', marginBottom: '16px' }}>
            <h4 style={{ margin: '0 0 8px 0', fontSize: '0.95rem', fontWeight: 800, color: '#854d0e' }}>⚡ Mandatory Data Points Required for Batch Minting:</h4>
        ...
        <article style={{ background: 'rgba(255, 255, 255, 0.9)', borderRadius: '24px', padding: '32px', border: '1.5px solid rgba(34, 197, 94, 0.5)', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            <span style={{ fontSize: '2rem' }}>🧪</span>
            <div>
              <span style={{ fontSize: '0.75rem', fontWeight: 900, textTransform: 'uppercase', color: '#166534', letterSpacing: '0.05em' }}>Role Dashboard 2</span>
              <h3 style={{ fontSize: '1.4rem', fontWeight: 900, color: '#0f172a', margin: 0 }}>NABL Accredited Quality Assurance Lab Portal</h3>
            </div>
          </div>
          <p style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '16px' }}>
          ...
          <div style={{ background: '#f0fdf4', border: '1px solid #86efac', borderRadius: '14px', padding: '16px 20px', marginBottom: '16px' }}>
            <h4 style={{ margin: '0 0 8px 0', fontSize: '0.95rem', fontWeight: 800, color: '#166534' }}>🔬 Laboratory Analytical Testing Suite:</h4>
        ...
        <article style={{ background: 'rgba(255, 255, 255, 0.9)', borderRadius: '24px', padding: '32px', border: '1.5px solid rgba(59, 130, 246, 0.5)', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            <span style={{ fontSize: '2rem' }}>🏪</span>
            <div>
              <span style={{ fontSize: '0.75rem', fontWeight: 900, textTransform: 'uppercase', color: '#1e40af', letterSpacing: '0.05em' }}>Role Dashboard 3</span>
              <h3 style={{ fontSize: '1.4rem', fontWeight: 900, color: '#0f172a', margin: 0 }}>Retailer Inventory & Cold-Chain Audit Portal</h3>
            </div>
          </div>
          <p style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '16px' }}>
        ...
        <article style={{ background: 'rgba(255, 255, 255, 0.9)', borderRadius: '24px', padding: '32px', border: '1.5px solid rgba(168, 85, 247, 0.5)', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
            <span style={{ fontSize: '2rem' }}>📱</span>
            <div>
              <span style={{ fontSize: '0.75rem', fontWeight: 900, textTransform: 'uppercase', color: '#6b21a8', letterSpacing: '0.05em' }}>Public Portal</span>
              <h3 style={{ fontSize: '1.4rem', fontWeight: 900, color: '#0f172a', margin: 0 }}>Public Consumer Verification & Feedback Portal</h3>
            </div>
          </div>
          <p style={{ color: '#475569', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '16px' }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => setCurrentView('login')} className="btn-white" style={{ padding: '14px 28px', fontSize: '1rem', fontWeight: 700 }}>
            🔑 Sign In to Platform
          </button>
        </div>
      </section>
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        {currentView === 'explore' && <ExploreView setCurrentView={setCurrentView} setSelectedBatchId={setSelectedBatchId} />}
